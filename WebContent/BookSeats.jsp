...
<body >
	<h3 align="right" class="text-primary">Welcome:${email}</h3>
			...
			<table width=500 align="center"  >
				...
				<tr>
					<td width="10%" align="center"><input type="hidden" id="1"
						name="1" value="no">
						<button type="button" class="btn btn-success" id="s1" onclick='check("s1","1")'>${Book.seat_s1}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="2"
						name="2" value="no">
						<button type="button" id="s2" class="btn btn-success" onclick='check("s2","2")'>${Book.seat_s2}</button>
					</td>
					<td width="20%"></td>
					<td width="10%" align="center"><input type="hidden" id="3"
						name="3" value="no">
						<button type="button" id="s3" class="btn btn-success" onclick='check("s3","3")'>${Book.seat_s3}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="4"
						name="4" value="no">
						<button type="button" id="s4" class="btn btn-success" onclick='check("s4","4")'>${Book.seat_s4}</button>
					</td>
				</tr>
				...
				<tr>
					<td width="10%" align="center"><input type="hidden" id="5"
						name="5" value="no">
						<button type="button" id="s5" class="btn btn-success" onclick='check("s5","5")'>${Book.seat_s5}</button>

					</td>
					<td width="10%" align="center"><input type="hidden" id="6"
						name="6" value="no">
						<button type="button" id="s6" class="btn btn-success" onclick='check("s6","6")'>${Book.seat_s6}</button>

					</td>
					<td width="20%"></td>
					<td width="10%" align="center"><input type="hidden" id="7"
						name="7" value="no">
						<button type="button" id="s7" class="btn btn-success" onclick='check("s7","7")'>${Book.seat_s7}</button>

					</td>
					<td width="10%" align="center"><input type="hidden" id="8"
						name="8" value="no">
						<button type="button" id="s8" class="btn btn-success" onclick='check("s8","8")'>${Book.seat_s8}</button>
				...
				<tr>
					<td width="10%" align="center"><input type="hidden" id="9"
						name="9" value="no">
						<button type="button" id="s9" class="btn btn-success" onclick='check("s9","9")'>${Book.seat_s9}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="10"
						name="10" value="no">
						<button type="button" id="s10" class="btn btn-success" onclick='check("s10","10")'>${Book.seat_s10}</button>

					</td>
					<td width="20%"></td>
					<td width="10%" align="center"><input type="hidden" id="11"
						name="11" value="no">
						<button type="button" id="s11" class="btn btn-success" onclick='check("s11","11")'>${Book.seat_s11}</button>

					</td>
					<td width="10%" align="center"><input type="hidden" id="12"
						name="12" value="no">
						<button type="button" id="s12" class="btn btn-success" onclick='check("s12","12")'>${Book.seat_s12}</button>
				...
				<tr>
					<td width="10%" align="center"><input type="hidden" id="13"
						name="13" value="no">
						<button type="button" id="s13" class="btn btn-success" onclick='check("s13","13")'>${Book.seat_s13}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="14"
						name="14" value="no">
						<button type="button" id="s14" class="btn btn-success" onclick='check("s14","14")'>${Book.seat_s14}</button>
					</td>
					<td width="20%"></td>
					<td width="10%" align="center"><input type="hidden" id="15"
						name="15" value="no">
						<button type="button" id="s15" class="btn btn-success" onclick='check("s15","15")'>${Book.seat_s15}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="16"
						name="16" value="no">
						<button type="button" id="s16" class="btn btn-success" onclick='check("s16","16")'>${Book.seat_s16}</button>
					</td>
				</tr>
				...
				<tr>
					<td width="10%" align="center"><input type="hidden" id="17"
						name="17" value="no">
						<button type="button" id="s17" class="btn btn-success" onclick='check("s17","17")'>${Book.seat_s17}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="18"
						name="18" value="no">
						<button type="button" id="s18" class="btn btn-success" onclick='check("s18","18")'>${Book.seat_s18}</button>
					</td>
					<td width="20%"></td>
					<td width="10%" align="center"><input type="hidden" id="19"
						name="19" value="no">
						<button type="button" id="s19" class="btn btn-success" onclick='check("s19","19")'>${Book.seat_s19}</button>
					</td>
					<td width="10%" align="center"><input type="hidden" id="20"
						name="20" value="no">
						<button type="button" id="s20" class="btn btn-success" onclick='check("s20","20")'>${Book.seat_s20}</button>
					</td>
				</tr>
			</table>
			<br>
